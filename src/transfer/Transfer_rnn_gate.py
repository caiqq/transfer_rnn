...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=None,
    ...
    if not _like_rnncell('cell_name', cell_fw):
        raise TypeError("cell_fw must be an instance of RNNCell")
    if not _like_rnncell('cell_name', cell_bw):
...
def dynamic_rnn(cell, inputs, sequence_length=None, initial_state=None,
    ...
    """
    if not _like_rnncell('cell_name', cell):
...
def tied_rnn_seq2seq(session, FLAGS, model_source,
    ...
    with vs.variable_scope("TL_combined_tied_rnn_seq2seq"):
        ...
        _, enc_state = static_rnn(session, FLAGS, model_source, w_h, w_s, w_t_h, w_t_s, cell, encoder_inputs,
