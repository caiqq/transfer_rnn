...
tf.app.flags.DEFINE_string("train_dir", os.path.normpath("./experiments_sufficient_lr0.5/"), "Training directory.")
...
fname = os.getcwd() + "/CML_sufficient_lr0.05/"
...
d = fname + "/{0}_sufficient_lr0.05.log".format(FLAGS.action)
